...
def add_message_bubble(side, text):
    ...
    if side == 'left':
        ...
        messages.insert(0, c.create_text((20, 460), text=text, anchor='nw', font=('Colibri', 11), fill='#f2f2f2'))
    ...
    if side == 'right':
        ...
        messages.insert(0, c.create_text((560, 460), text=text, anchor='nw', font=('Colibri', 11), fill='#f2f2f2'))
...
irina_text = c.create_text(410, 35, text='Официант Сириус', anchor='center', font=('Colibri', 16), fill='#606060')
